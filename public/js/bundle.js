...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibGFzaGExOTkiLCJhIjoiY2t6OGsyNHVoMHc5YTJ2czg0bTdtOWNpZSJ9.YY4bD4NnCCY6wO7utpf34g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/lasha199/ckz8ljsqb001q14tam0b4v0ng',
    scrollZoom: false // center: [-118.333, 34.323],
    // zoom: 10,
    // interactive: false
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            res = _context2.sent;
            (0, _alerts.showAlert)('success', 'Log out successfully');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res) (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));
            _context.next = 12;
            break;
...
var stripe = Stripe("pk_test_51KSPwCHCmZX8SMhHN23FS4vWvAEys5JZGVibLkyrBTjFxhGRLoDFLJzEKpiBT9NwxkCHP7iO0jSWZBpM1miwKBW000oPdrPxsc");
